...
def main(argv):
    ...
    for file_name in os.listdir(input_dir):
        ...
        while pack_time<2000 and (end_time - begin_time)<60:
            ...
            while  len(restBox)!=0:
                ...
                for box in restBox:
                    ...
                    while box.height>truck[chose_truck]['height'] or (max(box.width,box.length)>max(truck[chose_truck]['width'],truck[chose_truck]['length'])):
                        chose_truck = random.randint(0,truckOfNum - 1)
